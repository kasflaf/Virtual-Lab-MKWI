...
function signJws(header, payload, signer, encoding) {
    return __awaiter(this, void 0, void 0, function* () {
...
function signatureFromJWS(jwsSig, encoding) {
    encoding = encoding || "utf8";
    const sig = jwsSig.split(".")[2];
    if (sig)
        return buffer.Buffer.from(sig, "base64").toString(encoding);
...
function payloadFromJWS(jwsSig, encoding) {
    ...
    if (payload)
        return buffer.Buffer.from(payload, "base64").toString(encoding);
    else
...
function jwsVerify(verifier, jwsSig, address) {
    return __awaiter(this, void 0, void 0, function* () {
...
function decodeJws(jwsSig, encoding = "utf8") {
...
function decode(jwtString, options) {
...
function verify(jwtString, verifier, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const valid = yield jwsVerify(verifier, jwtString, decodedToken.payload.iss);
        if (!valid) {
...
function sign(payload, signer, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const payloadParseResult = payloadSchema.safeParse(payload);
        if (!payloadParseResult.success) {
            throw new InvalidPayloadError(JSON.parse(payloadParseResult.error.message)[0].message);
        ...
        return signJws(header, payload, signer, encoding);
    });
}

export { BaseDjwtError, InvalidPayloadError, InvalidSignOptionsError, JwaAddressIncorrectError, JwaVerifyError, JwsDecodingError, JwsVerifyError, NotBeforeError, OptionsVerificationError, TimespanDecodingError, TokenExpiredError, VerificationError, decode, sign, verify };
